...
This skill targets the opencode agent platform. In opencode, the abstract `ask_question` affordance is bound to the `question` tool. On other hosts, substitute the equivalent discrete-choice tool.
